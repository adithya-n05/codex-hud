...
`codex-hud` community a harassment-free experience for everyone, regardless of age,
...
- Project discussions and planning documents
- Any public or private communication that represents the project

## Reporting

If you experience or witness unacceptable behavior, report it privately to the
maintainers using GitHub's private reporting flow:

- https://github.com/adithya-n05/codex-hud/security/advisories/new

Please include links, screenshots, and any other context that can help us review
the report. All reports will be handled promptly and fairly.
...
around the violation and an explanation of why the behavior was inappropriate.
